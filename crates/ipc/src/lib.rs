...
pub struct ServiceReadinessState {
    ...
    pub privileged_service_ready: bool,
    pub tun_path_allowed: bool,
    pub adapter_path_allowed: bool,
...
impl Default for ServiceReadinessState {
    fn default() -> Self {
        Self {
            ...
            identity_source: "process-path".to_string(),
            signing_state: "unsigned-dev".to_string(),
            signing_valid: false,
            signing_source: "unsigned-or-unattested".to_string(),
            running_as_admin: false,
            privileged_policy_allowed: false,
            privileged_service_ready: false,
            tun_path_allowed: false,
