...
- Polished subscription and navigation action icons with reference-matched refresh, speedometer, pin, clipboard, sliders, delete, globe, gear-shaped settings, statistics, logs, and about glyphs.
...
```text
dist\SamhainSecurityNative-1.1.7-win-x64
```
...
.\scripts\write-release-evidence.ps1 -ExpectedVersion 1.1.7
```
