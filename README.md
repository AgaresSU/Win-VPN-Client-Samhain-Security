...
- Polished subscription and navigation action icons with clearer refresh, speedometer, pushpin, copy, edit, delete, globe, gear-shaped settings, statistics, logs, and about glyphs.
...
```text
dist\SamhainSecurityNative-1.1.6-win-x64
```
...
.\scripts\write-release-evidence.ps1 -ExpectedVersion 1.1.6
```
