...
Add-Check "manifest:installer-status" ($manifest.install.signedInstaller.status -eq "toolchain-preflight-unsigned-msi-dry-run") ([string]$manifest.install.signedInstaller.status)
...
Add-Check "manifest:installer-build-plan" ($manifest.install.signedInstaller.buildPlan -eq "installer\installer-build-plan.json") ([string]$manifest.install.signedInstaller.buildPlan)
Add-Check "manifest:installer-preflight" ($manifest.install.signedInstaller.preflight -eq "tools\test-installer-toolchain.ps1") ([string]$manifest.install.signedInstaller.preflight)
Add-Check "manifest:installer-skeleton-preflight" ($manifest.install.signedInstaller.skeletonPreflight -eq "tools\test-installer-skeleton.ps1") ([string]$manifest.install.signedInstaller.skeletonPreflight)
Add-Check "manifest:installer-toolchain-preflight" ($manifest.install.signedInstaller.toolchainPreflight -eq "tools\test-installer-toolchain.ps1") ([string]$manifest.install.signedInstaller.toolchainPreflight)
...
Add-Check "manifest:installer-toolchain" ($manifest.verification.installerToolchainScript -eq "tools\test-installer-toolchain.ps1") ([string]$manifest.verification.installerToolchainScript)
...
Add-Check "manifest:signed-installer-status" ($manifest.signedInstaller.status -eq "toolchain-preflight-unsigned-msi-dry-run") ([string]$manifest.signedInstaller.status)
...
Add-Check "manifest:signed-installer-build-plan" ($manifest.signedInstaller.buildPlan -eq "installer\installer-build-plan.json") ([string]$manifest.signedInstaller.buildPlan)
